...
| 項目 | 内容 |
|------|------|
| 公開状況 | **WordPress.org 公開済み**（slug `smart-booking`、公開バージョン **v0.5.6**、2026-09-12、SVN rev 3692196） |
| 次バージョン | **v0.5.7（メールタブのレース）— 起票のみ・実装未着手**。計画: `docs/plans/v0.5.7-release-plan.md` |
